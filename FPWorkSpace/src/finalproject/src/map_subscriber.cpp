...
void mapSubscriber(const nav_msgs::msg::OccupancyGrid::SharedPtr msg,
  ...
  std::cout << msg->info.height << " height fr\n";
  std::cout << msg->info.width << " width fr\n";
  std::cout << msg->info.resolution << " resolution fr\n";
...
// void mapSubscriber(const nav_msgs::msg::OccupancyGrid::SharedPtr msg,
// std::ofstream& outfile, std::vector<int8_t>& data)
// {
...
//         for (unsigned int col = 0; col < msg->info.width; col++)
//         {
//             int value = static_cast<int>(msg->data[row * msg->info.width +
//             col]); if (value == 0 || value == 100)
//             {
//                 data[row * msg->info.width + col] =
...
int main(int argc, char **argv) {
  ...
  std::ofstream outfile(
      "/home/speet/Documents/23S-CSE180-Project/FPWorkSpace/"
      "src/finalproject/src/txtFolders/extraPostMapOutputAll.txt");
